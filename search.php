<?php
    ...
    if(isset($_POST))
    {
        ...
        if($genre == "All")
        {
            $books_json = file_get_contents("https://www.googleapis.com/books/v1/volumes?q=intitle:$search&maxResults=20&startIndex=1");
            $books = json_decode($books_json,true);
        }
        else
        {
            $books_json = file_get_contents("https://www.googleapis.com/books/v1/volumes?q=intitle:$search&subject:$genre&maxResults=20&startIndex=1");
            $books = json_decode($books_json,true);
        }
    }
